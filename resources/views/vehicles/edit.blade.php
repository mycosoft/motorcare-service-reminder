	...
	<div class="col-md-12">
		<div class="card card-primary">
			<div class="card-header">
				<h3 class="card-title">Edit Vehicle: {{ $vehicle->make }} {{ $vehicle->model }}</h3>
			</div>
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="number" class="form-control @error('current_mileage') is-invalid @enderror" 
									...
									value="{{ old('current_mileage', $vehicle->current_mileage) }}" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" class="form-control @error('service_interval_months') is-invalid @enderror" 
									...
									value="{{ old('service_interval_months', $vehicle->service_interval_months) }}" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" class="form-control @error('service_interval_miles') is-invalid @enderror" 
									...
									value="{{ old('service_interval_miles', $vehicle->service_interval_miles) }}" required>
