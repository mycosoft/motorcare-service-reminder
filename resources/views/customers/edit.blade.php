							...
							<div class="form-group">
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input" 
										...
										value="1" {{ old('notification_preference_email', $customer->notification_preference_email) ? 'checked' : '' }}>
							...
							<div class="form-group">
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input" 
										...
										value="1" {{ old('notification_preference_sms', $customer->notification_preference_sms) ? 'checked' : '' }}>
